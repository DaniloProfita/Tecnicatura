...
#Segundo objeto de la clase Auto (Hijo de Vehiculo)
auto = Auto('Violeta', 4, 100)
print(auto)


#Tercer objeto de la clase Bicicleta (Hijo de Vehiculo)
bicicleta = Bicicleta('Amarilla', 2, 'montania')
print(bicicleta)